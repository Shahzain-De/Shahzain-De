...
### 🛠️ What I am Building & Learning
I use data visualization and analytical tools to find actionable user insights that shape product roadmaps:

- 📊 **Power BI & Excel:** Designing business intelligence dashboards, cohort analyses, and key product performance metrics (KPIs).
- 🧭 **Product Strategy:** Learning to draft PRDs (Product Requirement Documents), map user journeys, and run A/B testing analysis.
- ⚙️ **Process Automation:** Streamlining data workflows to make quicker product lifecycle decisions.
